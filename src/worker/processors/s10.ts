...
//
// Machine_Normal_Lp is deliberately ignored: it is the tile's idle ambient loop,
// which starts on proximity. Across 105 tiles it preceded the real activation by
// up to 43.8s (16% by more than 10s), so starting on it credited the tracker with
// the walk-up. Monster spawns align to the millisecond with Machine_*_Active_Lp.
//
